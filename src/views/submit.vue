  ...
  <div>
    <div v-if="level==3">
      <van-row>
        ...
        <van-col span="15" style="margin-left:-2px">
          <div v-if="activeKey === 0">
            ...
            <van-cell-group>
              <van-field required v-model="number" placeholder="请输入手机号" :error-message="numerr" />
            </van-cell-group>
            <van-cell-group>
            ...
            <van-uploader
              ...
              name="param"
            />
            <van-button type="default" v-on:click="submit">提交</van-button>
          </div>
              ...
              <van-collapse v-model="activeNames">
                ...
                >
                  ...
                  <div v-for="a in ar.base" :key="a.base">
                    <img :src="address+a" alt style="height:50px; width:50px;" v-on:click="look(i)" />
                  </div>
                </van-collapse-item>
              </van-collapse>
              <template slot="right">
                ...
                />
                <van-button square type="danger" text="删除" v-on:click="del(ar._id)" />
              </template>
            </van-swipe-cell>
